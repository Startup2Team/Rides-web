    ...
    <main className="relative flex-1 overflow-hidden">
      <section className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-5 py-12 sm:gap-12 sm:px-6 sm:py-16 lg:min-h-[calc(100vh-5rem)] lg:grid-cols-2 lg:gap-20 lg:py-24">
        ...
        <div className="relative">
          <h1 className="text-balance text-[2.75rem] font-bold leading-[1.02] tracking-[-0.035em] text-foreground sm:text-6xl md:text-7xl lg:text-8xl">
            Let&apos;s talk<span className="text-primary">?</span>
          </h1>
          <p className="mt-5 max-w-md text-balance text-sm leading-relaxed text-muted-foreground sm:mt-6 sm:text-base">
